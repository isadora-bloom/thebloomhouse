...
INSERT INTO tours (id, venue_id, wedding_id, scheduled_at, tour_type, conducted_by, source, outcome, booking_date, competing_venues, notes) VALUES
  ...
  ('dddd0025-0001-0001-0001-000000000006', '22222222-2222-2222-2222-222222222201', '44444444-4444-4444-4444-444444000114', '2026-04-01 14:00:00+00', 'in_person', '33333333-3333-3333-3333-333333333301', 'the_knot', NULL, NULL, ARRAY[], 'Upcoming tour — hot lead, 200 guests. Mentioned outdoor ceremony is a must.'),
  ...
  ('dddd0025-0001-0001-0001-000000000008', '22222222-2222-2222-2222-222222222201', NULL, '2026-02-14 10:00:00+00', 'in_person', '33333333-3333-3333-3333-333333333301', 'google', 'cancelled', NULL, ARRAY[], 'Cancelled day-of — said they found a venue closer to DC.'),
  ('dddd0025-0001-0001-0001-000000000009', '22222222-2222-2222-2222-222222222201', NULL, '2026-03-08 14:00:00+00', 'virtual', '33333333-3333-3333-3333-333333333301', 'weddingwire', 'no_show', NULL, ARRAY[], 'No-show for virtual tour. Follow-up email sent.'),
  ('dddd0025-0001-0001-0001-000000000010', '22222222-2222-2222-2222-222222222201', NULL, '2026-03-12 11:00:00+00', 'in_person', '33333333-3333-3333-3333-333333333301', 'the_knot', 'rescheduled', NULL, ARRAY[], 'Rescheduled to April 5 due to weather.')
ON CONFLICT (id) DO NOTHING;
