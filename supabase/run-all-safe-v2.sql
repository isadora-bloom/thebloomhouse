...
-- review_language
CREATE INDEX IF NOT EXISTS idx_review_language_venue_id ON review_language(venue_id);
...
-- (In case venues/organisations were created by a different schema)
-- ============================================

-- Venues columns needed by the app
ALTER TABLE venues ADD COLUMN IF NOT EXISTS org_id uuid REFERENCES organisations(id);
ALTER TABLE venues ADD COLUMN IF NOT EXISTS plan_tier text DEFAULT 'starter';
...
ALTER TABLE venues ADD COLUMN IF NOT EXISTS heat_score integer DEFAULT 0;
ALTER TABLE venues ADD COLUMN IF NOT EXISTS temperature_tier text DEFAULT 'cool';
