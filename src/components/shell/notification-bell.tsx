  ...
  return (
    <div className="relative">
      <button
        ...
        className="relative flex items-center justify-center w-11 h-11 lg:w-8 lg:h-8 rounded-full text-sage-600 hover:bg-sage-50 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-sage-400"
      >
        {hasUnread ? (
