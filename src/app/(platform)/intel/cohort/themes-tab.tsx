...
/**
 * /intel/cohort — "Themes" tab (Wave 5B cohort intelligence).
 *
 * Anchor docs:
 ...
 *     evidence)
 *
 * This is the LLM-driven half of /intel/cohort. The deterministic
 * couple-keyed funnel + timing metrics live in the sibling
 * "Funnel & Timing" tab (D9, Tier 8).
 *
 * Sensitivity gating
 * ------------------
