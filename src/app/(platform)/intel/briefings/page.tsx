...
interface BriefingContent {
  ...
  generated_at: string
  // Connective II / fix #2: structured anomaly explanations + actions.
  ...
  // Connective tissue (gap E): Phase B counts.
  phase_b?: {
    ...
    <div className="space-y-8">
      ...
      {!loading && content && (!content.sections || content.sections.length === 0) && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          {/* Anomaly Summary — Connective II / fix #2: prefer structured
              anomaly_details (metric + AI explanation + suggested
              action) when present; fall back to the AI's summary
              array for legacy briefings without the new field. */}
          <div className="bg-surface border border-border rounded-xl p-6 shadow-sm">
            <h3 className="font-heading text-base font-semibold text-sage-900 mb-4 flex items-center gap-2">
