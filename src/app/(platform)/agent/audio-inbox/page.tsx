    ...
    <div className="max-w-5xl space-y-6">
      <header className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-sage-600 mt-1">
            Transcripts from your audio-capture providers that couldn&apos;t be matched to a
      ...
      {loading ? (
        ...
        <div className="text-sm text-sage-500 border border-dashed border-border rounded-lg px-4 py-10 text-center">
          Nothing to triage. Orphaned audio-capture sessions will show up here for attach or dismissal.
        </div>
      ) : (
