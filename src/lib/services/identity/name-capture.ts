...
export type NameSource =
  ...
  | 'reconstruct_profile_partner1'  // 2026-05-13 mirror of partner2 branch: judge had a confident partner1 claim but no partner1 row existed; profile-to-people-sync minted from profile. Same confidence as partner2 mint.
...
const CONFIDENCE_BY_SOURCE: Record<NameSource, number> = {
  ...
  reconstruct_profile_partner1: 90,
}
